...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.CARACT_SA in the schema.
    /// </summary>
    /// <KeyProperties>
    /// MODELO
    /// VARIANTE
    /// POS
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="CARACT_SA")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class CARACT_SA : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new CARACT_SA object.
        /// </summary>
        ...
        public static CARACT_SA CreateCARACT_SA(string mODELO, string vARIANTE, int pOS)
        {
            CARACT_SA cARACT_SA = new CARACT_SA();
            cARACT_SA.MODELO = mODELO;
            cARACT_SA.VARIANTE = vARIANTE;
            cARACT_SA.POS = pOS;
            return cARACT_SA;
        }
        ...
        private global::System.Nullable<decimal> _PERC = 0m;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_CARACT_SA_ARTIGOS", "ARTIGOS")]
        public ARTIGOS ARTIGOS
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_CARACT_SA_ARTIGOS", "ARTIGOS").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_CARACT_SA_ARTIGOS", "ARTIGOS").Value = value;
            }
        }
        ...
        public EntityReference<ARTIGOS> ARTIGOSReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_CARACT_SA_ARTIGOS", "ARTIGOS");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_CARACT_SA_ARTIGOS", "ARTIGOS", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_CARACT_SA_ARTIGOS", "ARTIGOS").Value = null;
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_CARACT_SA_PECAS", "PECAS")]
        public PECAS PECAS
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<PECAS>("DataGiic_LiagoModel.FK_CARACT_SA_PECAS", "PECAS").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<PECAS>("DataGiic_LiagoModel.FK_CARACT_SA_PECAS", "PECAS").Value = value;
            }
        }
        ...
        public EntityReference<PECAS> PECASReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<PECAS>("DataGiic_LiagoModel.FK_CARACT_SA_PECAS", "PECAS");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<PECAS>("DataGiic_LiagoModel.FK_CARACT_SA_PECAS", "PECAS", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<PECAS>("DataGiic_LiagoModel.FK_CARACT_SA_PECAS", "PECAS").Value = null;
                }
            }
        }
        ...
        {
          CARACT_SA toCompare = obj as CARACT_SA;
          if (toCompare == null)
          {
            return false;
          }
