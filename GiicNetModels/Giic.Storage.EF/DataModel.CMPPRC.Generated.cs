...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.CMPPRC in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NRENCO
    /// LNENCO
    /// IDOTAM
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="CMPPRC")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class CMPPRC : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new CMPPRC object.
        /// </summary>
        ...
        public static CMPPRC CreateCMPPRC(string nRENCO, int lNENCO, short iDOTAM)
        {
            CMPPRC cMPPRC = new CMPPRC();
            cMPPRC.NRENCO = nRENCO;
            cMPPRC.LNENCO = lNENCO;
            cMPPRC.IDOTAM = iDOTAM;
            return cMPPRC;
        }
        ...
        {
          CMPPRC toCompare = obj as CMPPRC;
          if (toCompare == null)
          {
            return false;
          }
