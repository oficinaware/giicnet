...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.DICIONARIO_VAGA in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NATIVO
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="DICIONARIO_VAGA")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class DICIONARIO_VAGA : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new DICIONARIO_VAGA object.
        /// </summary>
        /// <param name="nATIVO">Initial value of NATIVO.</param>
        public static DICIONARIO_VAGA CreateDICIONARIO_VAGA(string nATIVO)
        {
            DICIONARIO_VAGA dICIONARIO_VAGA = new DICIONARIO_VAGA();
            dICIONARIO_VAGA.NATIVO = nATIVO;
            return dICIONARIO_VAGA;
        }
        ...
        {
            DICIONARIO_VAGA obj = new DICIONARIO_VAGA();
            obj.NATIVO = NATIVO;
            obj.INGLES = INGLES;
            obj.FRANCES = FRANCES;
        ...
        {
          DICIONARIO_VAGA toCompare = obj as DICIONARIO_VAGA;
          if (toCompare == null)
          {
            return false;
          }
