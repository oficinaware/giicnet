...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.ENCOPRC in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NRENCO
    /// LNENCO
    /// IDOTAM
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="ENCOPRC")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ENCOPRC : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new ENCOPRC object.
        /// </summary>
        ...
        public static ENCOPRC CreateENCOPRC(string nRENCO, int lNENCO, short iDOTAM)
        {
            ENCOPRC eNCOPRC = new ENCOPRC();
            eNCOPRC.NRENCO = nRENCO;
            eNCOPRC.LNENCO = lNENCO;
            eNCOPRC.IDOTAM = iDOTAM;
            return eNCOPRC;
        }
        ...
        {
          ENCOPRC toCompare = obj as ENCOPRC;
          if (toCompare == null)
          {
            return false;
          }
