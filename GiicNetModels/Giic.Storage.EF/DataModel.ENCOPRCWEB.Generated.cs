...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.ENCOPRCWEB in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NRENCO
    /// LNENCO
    /// IDOTAM
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="ENCOPRCWEB")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ENCOPRCWEB : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new ENCOPRCWEB object.
        /// </summary>
        ...
        public static ENCOPRCWEB CreateENCOPRCWEB(string nRENCO, int lNENCO, short iDOTAM)
        {
            ENCOPRCWEB eNCOPRCWEB = new ENCOPRCWEB();
            eNCOPRCWEB.NRENCO = nRENCO;
            eNCOPRCWEB.LNENCO = lNENCO;
            eNCOPRCWEB.IDOTAM = iDOTAM;
            return eNCOPRCWEB;
        }
        ...
        {
          ENCOPRCWEB toCompare = obj as ENCOPRCWEB;
          if (toCompare == null)
          {
            return false;
          }
