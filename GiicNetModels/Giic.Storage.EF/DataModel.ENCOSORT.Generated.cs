...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.ENCOSORT in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NRENCO
    /// LNENCO
    /// pos
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="ENCOSORT")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ENCOSORT : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new ENCOSORT object.
        /// </summary>
        ...
        public static ENCOSORT CreateENCOSORT(string nRENCO, int lNENCO, int pos)
        {
            ENCOSORT eNCOSORT = new ENCOSORT();
            eNCOSORT.NRENCO = nRENCO;
            eNCOSORT.LNENCO = lNENCO;
            eNCOSORT.pos = pos;
            return eNCOSORT;
        }
        ...
        private global::System.Nullable<int> _QTSORT = 1;
        ...
        {
          ENCOSORT toCompare = obj as ENCOSORT;
          if (toCompare == null)
          {
            return false;
          }
