...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.ENCOSORTWEB in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NRENCO
    /// LNENCO
    /// pos
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="ENCOSORTWEB")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ENCOSORTWEB : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new ENCOSORTWEB object.
        /// </summary>
        ...
        public static ENCOSORTWEB CreateENCOSORTWEB(string nRENCO, int lNENCO, int pos)
        {
            ENCOSORTWEB eNCOSORTWEB = new ENCOSORTWEB();
            eNCOSORTWEB.NRENCO = nRENCO;
            eNCOSORTWEB.LNENCO = lNENCO;
            eNCOSORTWEB.pos = pos;
            return eNCOSORTWEB;
        }
        ...
        {
            ENCOSORTWEB obj = new ENCOSORTWEB();
            obj.NRENCO = NRENCO;
            obj.LNENCO = LNENCO;
            obj.pos = pos;
            obj.TIPSORT = TIPSORT;
        ...
        {
          ENCOSORTWEB toCompare = obj as ENCOSORTWEB;
          if (toCompare == null)
          {
            return false;
          }
