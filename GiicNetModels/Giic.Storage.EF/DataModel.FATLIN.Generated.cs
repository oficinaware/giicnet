...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.FATLIN in the schema.
    /// </summary>
    /// <KeyProperties>
    /// TPDOC
    /// NRFACT
    /// LNFACT
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="FATLIN")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class FATLIN : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new FATLIN object.
        /// </summary>
        ...
        public static FATLIN CreateFATLIN(string tPDOC, int nRFACT, int lNFACT)
        {
            FATLIN fATLIN = new FATLIN();
            fATLIN.TPDOC = tPDOC;
            fATLIN.NRFACT = nRFACT;
            fATLIN.LNFACT = lNFACT;
            return fATLIN;
        }
        ...
        private global::System.Nullable<int> _NRSORT = 0;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_FATLIN_MODELOS", "MODELOS")]
        public MODELOS MODELOS
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<MODELOS>("DataGiic_LiagoModel.FK_FATLIN_MODELOS", "MODELOS").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<MODELOS>("DataGiic_LiagoModel.FK_FATLIN_MODELOS", "MODELOS").Value = value;
            }
        }
        ...
        public EntityReference<MODELOS> MODELOSReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<MODELOS>("DataGiic_LiagoModel.FK_FATLIN_MODELOS", "MODELOS");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<MODELOS>("DataGiic_LiagoModel.FK_FATLIN_MODELOS", "MODELOS", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<MODELOS>("DataGiic_LiagoModel.FK_FATLIN_MODELOS", "MODELOS").Value = null;
                }
            }
        }
        ...
        {
          FATLIN toCompare = obj as FATLIN;
          if (toCompare == null)
          {
            return false;
          }
