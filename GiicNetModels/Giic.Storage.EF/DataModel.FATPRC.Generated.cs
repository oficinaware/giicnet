...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.FATPRC in the schema.
    /// </summary>
    /// <KeyProperties>
    /// TPDOC
    /// NRFACT
    ...
    /// IDOTAM
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="FATPRC")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class FATPRC : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new FATPRC object.
        /// </summary>
        ...
        public static FATPRC CreateFATPRC(string tPDOC, int nRFACT, int lNFACT, short iDOTAM)
        {
            FATPRC fATPRC = new FATPRC();
            fATPRC.TPDOC = tPDOC;
            fATPRC.NRFACT = nRFACT;
            fATPRC.LNFACT = lNFACT;
            fATPRC.IDOTAM = iDOTAM;
            return fATPRC;
        }
        ...
        {
          FATPRC toCompare = obj as FATPRC;
          if (toCompare == null)
          {
            return false;
          }
