...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.STKMOV in the schema.
    /// </summary>
    /// <KeyProperties>
    /// NRREG
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="STKMOV")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class STKMOV : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new STKMOV object.
        /// </summary>
        ...
        public static STKMOV CreateSTKMOV(int nRREG, string cODMOV, string nRDOCI, int lNDOC, string aRMORIG, string aRTIGO, string cARTAZ, string cODCOR, string tAM, int iDLOTE, string iDLOCAL)
        {
            STKMOV sTKMOV = new STKMOV();
            sTKMOV.NRREG = nRREG;
            sTKMOV.CODMOV = cODMOV;
            sTKMOV.NRDOCI = nRDOCI;
            sTKMOV.LNDOC = lNDOC;
            sTKMOV.ARMORIG = aRMORIG;
            sTKMOV.ARTIGO = aRTIGO;
            sTKMOV.CARTAZ = cARTAZ;
            sTKMOV.CODCOR = cODCOR;
            sTKMOV.TAM = tAM;
            sTKMOV.IDLOTE = iDLOTE;
            sTKMOV.IDLOCAL = iDLOCAL;
            return sTKMOV;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_STKMOV_STKTAR", "STKTAR")]
        public STKTAR STKTAR
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<STKTAR>("DataGiic_LiagoModel.FK_STKMOV_STKTAR", "STKTAR").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<STKTAR>("DataGiic_LiagoModel.FK_STKMOV_STKTAR", "STKTAR").Value = value;
            }
        }
        ...
        public EntityReference<STKTAR> STKTARReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<STKTAR>("DataGiic_LiagoModel.FK_STKMOV_STKTAR", "STKTAR");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<STKTAR>("DataGiic_LiagoModel.FK_STKMOV_STKTAR", "STKTAR", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<STKTAR>("DataGiic_LiagoModel.FK_STKMOV_STKTAR", "STKTAR").Value = null;
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_STKMOV_ARTIGOS", "ARTIGOS")]
        public ARTIGOS ARTIGOS
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_STKMOV_ARTIGOS", "ARTIGOS").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_STKMOV_ARTIGOS", "ARTIGOS").Value = value;
            }
        }
        ...
        public EntityReference<ARTIGOS> ARTIGOSReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_STKMOV_ARTIGOS", "ARTIGOS");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_STKMOV_ARTIGOS", "ARTIGOS", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<ARTIGOS>("DataGiic_LiagoModel.FK_STKMOV_ARTIGOS", "ARTIGOS").Value = null;
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_STKMOV_TABDOC", "TABDOC")]
        public TABDOC TABDOC
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<TABDOC>("DataGiic_LiagoModel.FK_STKMOV_TABDOC", "TABDOC").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<TABDOC>("DataGiic_LiagoModel.FK_STKMOV_TABDOC", "TABDOC").Value = value;
            }
        }
        ...
        public EntityReference<TABDOC> TABDOCReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<TABDOC>("DataGiic_LiagoModel.FK_STKMOV_TABDOC", "TABDOC");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<TABDOC>("DataGiic_LiagoModel.FK_STKMOV_TABDOC", "TABDOC", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<TABDOC>("DataGiic_LiagoModel.FK_STKMOV_TABDOC", "TABDOC").Value = null;
                }
            }
        }
        ...
        {
          STKMOV toCompare = obj as STKMOV;
          if (toCompare == null)
          {
            return false;
          }
