...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.TABSUBFAM in the schema.
    /// </summary>
    /// <KeyProperties>
    /// FAMILIA
    /// SUBFAM
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="TABSUBFAM")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class TABSUBFAM : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new TABSUBFAM object.
        /// </summary>
        /// <param name="fAMILIA">Initial value of FAMILIA.</param>
        /// <param name="sUBFAM">Initial value of SUBFAM.</param>
        public static TABSUBFAM CreateTABSUBFAM(string fAMILIA, string sUBFAM)
        {
            TABSUBFAM tABSUBFAM = new TABSUBFAM();
            tABSUBFAM.FAMILIA = fAMILIA;
            tABSUBFAM.SUBFAM = sUBFAM;
            return tABSUBFAM;
        }
        ...
        {
          TABSUBFAM toCompare = obj as TABSUBFAM;
          if (toCompare == null)
          {
            return false;
          }
