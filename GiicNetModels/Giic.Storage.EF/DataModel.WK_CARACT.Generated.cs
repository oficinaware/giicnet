...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.WK_CARACT in the schema.
    /// </summary>
    /// <KeyProperties>
    /// SPID
    /// MODELO
    ...
    /// POS
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="WK_CARACT")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class WK_CARACT : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new WK_CARACT object.
        /// </summary>
        ...
        public static WK_CARACT CreateWK_CARACT(int sPID, string mODELO, string vARIANTE, int pOS)
        {
            WK_CARACT wK_CARACT = new WK_CARACT();
            wK_CARACT.SPID = sPID;
            wK_CARACT.MODELO = mODELO;
            wK_CARACT.VARIANTE = vARIANTE;
            wK_CARACT.POS = pOS;
            return wK_CARACT;
        }
        ...
        {
          WK_CARACT toCompare = obj as WK_CARACT;
          if (toCompare == null)
          {
            return false;
          }
