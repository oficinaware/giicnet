...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.cabcores in the schema.
    /// </summary>
    /// <KeyProperties>
    /// cartaz
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="cabcores")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class cabcores : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new cabcores object.
        /// </summary>
        /// <param name="cartaz">Initial value of cartaz.</param>
        public static cabcores Createcabcores(string cartaz)
        {
            cabcores cabcores = new cabcores();
            cabcores.cartaz = cartaz;
            return cabcores;
        }
        ...
        /// <summary>
        /// There are no comments for CORES in the schema.
        /// </summary>
        [XmlIgnoreAttribute()]
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("DataGiic_LiagoModel", "FK_CORES_cabcores", "CORES")]
        public EntityCollection<CORES> CORES
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedCollection<CORES>("DataGiic_LiagoModel.FK_CORES_cabcores", "CORES");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedCollection<CORES>("DataGiic_LiagoModel.FK_CORES_cabcores", "CORES", value);
                }
            }
        }
        ...
        {
          cabcores toCompare = obj as cabcores;
          if (toCompare == null)
          {
            return false;
          }
