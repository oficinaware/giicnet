...
namespace DataGiic_LiagoModel
{
    ...
    /// <summary>
    /// There are no comments for DataGiic_LiagoModel.wkcmprecl in the schema.
    /// </summary>
    /// <KeyProperties>
    /// spid
    /// TPDOC
    ...
    /// LNFACT
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="DataGiic_LiagoModel", Name="wkcmprecl")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class wkcmprecl : EntityObject, ICloneable    {
        #region Factory Method

        /// <summary>
        /// Create a new wkcmprecl object.
        /// </summary>
        ...
        public static wkcmprecl Createwkcmprecl(int spid, string tPDOC, int nRFACT, int lNFACT)
        {
            wkcmprecl wkcmprecl = new wkcmprecl();
            wkcmprecl.spid = spid;
            wkcmprecl.TPDOC = tPDOC;
            wkcmprecl.NRFACT = nRFACT;
            wkcmprecl.LNFACT = lNFACT;
            return wkcmprecl;
        }
        ...
        {
          wkcmprecl toCompare = obj as wkcmprecl;
          if (toCompare == null)
          {
            return false;
          }
